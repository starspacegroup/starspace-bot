...
export const insult = {
  command: new SlashCommandBuilder()
    ...
    .addUserOption((option) =>
      option.setName("user").setDescription("The user to insult")
    )
...
Insults.push.apply(Insults, [
  ...
  `You are a walking pile of garbage.`,
  `Your breath smells like rotting fish and dead flowers.`,
  `You have more holes in your head than Swiss cheese.`,
  `You look like you were mugged by a gorilla and left for dead.`,
  `Your hair is greasier than a seal's fur.`,
  `Your eyes are as blue as a dirty diaper.`,
  `You have a face that could stop traffic, but it doesn't.`,
  `Your breath is worse than a garbage truck on a hot day.`,
  `You should be ashamed of yourself, but you aren't.`,
  `You make me want to stick my head in an oven.`,
  `You are a walking disaster area.`,
  `Your smile looks like it was painted on with a fork.`,
  `You have more zits than a teenager's acne-prone forehead.`,
  `Your laugh sounds like a hyena with a cold.`,
  `You have more baggage than a Samsonite commercial.`,
  `Your personality is as dull as watching paint dry.`,
  `You are as charming as a root canal without novocaine.`,
  `Your fashion sense makes me want to vomit.`,
  `You have more enemies than the mob boss from The Godfather.`,
  `Your breath smells like a sewer full of rotting fish.`,
  `You are a walking talking pile of crap.`,
  `Your hair is so greasy I can see the light bulb above your head.`,
  `You look like you just came out of a weeklong drug binge.`,
  `Your breath stinks so bad, it could knock over a linebacker.`,
  `You have more scars and wrinkles than a prune.`,
  `Your smile is as fake as a politician's promise.`,
  `You make me want to take a shower after looking at you.`,
  `Your breath is worse than a skunk's morning coffee.`,
  `You should be ashamed of yourself for being such a loser.`,
  `You are a walking disaster waiting to happen.`,
])
